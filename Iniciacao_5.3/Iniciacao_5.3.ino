...
//Variáveis locais
int i = 0, z = 1, esq = 0, cr = 0, Inicr = 0, infoA = 0, infoB = 0;
float passaTemp;
float by = 0;
...
void setup() {
  ...
  //xTaskCreatePinnedToCore(EscreveMQTT, "EscreveMQTT", 1000, NULL, 1, NULL, Nucleo_Zero);
  delay(500);
}
...
/*void EscreveMQTT(void* pvParameters) {
  while (1) {
     if (passaTemp != by) {
      by = passaTemp;
      i++;
